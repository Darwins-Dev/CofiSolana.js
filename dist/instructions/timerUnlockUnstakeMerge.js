...
exports.timerUnlockUnstakeMerge = void 0;
const address_1 = require("../utils/address");
const types_1 = require("../types");
const anchor_1 = require("@project-serum/anchor");
function timerUnlockUnstakeMerge(cofiSolanaConfig, stakerAuthority, stakerAccount, beneficiaryAccount, timerOwnedAccount, timerCofiStakeAccount) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield cofiTimerProgram.methods.unlockUnstakeMerge()
            .accounts({
...
exports.timerUnlockUnstakeMerge = timerUnlockUnstakeMerge;
